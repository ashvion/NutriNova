...
async def chat_with_agent(request: schemas.ChatRequest) -> dict:
    client = genai.Client(api_key=configs.GOOGLE_API_KEY)
    
    prompt = "You are a helpful, friendly, and expert nutrition and diet assistant for the Smart Diet Planner app.\n"
    prompt += "Answer the user's latest message considering the following conversation history. Be somewhat concise.\n\n"
